                                                                                                                                                ...
                                                                                                                                                observeds =
                                                                                                                                                    strip
                                                                                                                                                        ''
                                                                                                                                                            ...
                                                                                                                                                            OBSERVED_02_LOG=$( ${ pkgs.coreutils }/bin/cat /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 06" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 03" else "" }" ${ scripts.util.identity } ) ) &&
                                                                                                                                                        '' ;
                                                                                                                                            }
                                                                                                                                        else
                                                                                                                                            {
                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    ${ not-equals [ "OBSERVED_01_STANDARD_OUTPUT" "OBSERVED_02_STANDARD_OUTPUT" "OBSERVED_03_STANDARD_OUTPUT" "OBSERVED_04_STANDARD_OUTPUT" "OBSERVED_05_STANDARD_OUTPUT" "OBSERVED_07_STANDARD_OUTPUT" ] }
                                                                                                                                            '' ;
                                                                                                                        in
                                                                                                                            [
                                                                                                                                # ( script true true )
