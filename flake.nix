                                                                                    ...
                                                                                    verification =
                                                                                        {
                                                                                            bad =
                                                                                                {
                                                                                                    bad = temporary : { temporary = temporary.cache.bad.bad.fast ; epoch = 4 ; } ;
                                                                                                    good = temporary : { temporary = temporary.cache.bad.good.fast ; epoch = 4 ; } ;
                                                                                                } ;
                                                                                            good =
                                                                                                {
                                                                                                    bad = temporary : { temporary = temporary.cache.good.bad.fast ; epoch = 4 ; } ;
                                                                                                    good = temporary : { temporary = temporary.cache.good.good.fast ; epoch = 4 ; } ;
                                                                                                } ;
                                                                                        } ;
                                                                                } ;
