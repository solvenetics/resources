                                                                                                ...
                                                                                                { pkgs , ... } : target :
                                                                                                    ''
                                                                                                        COMMAND=${ environment-variable 1 } &&
                                                                                                            ...
                                                                                                            ${ environment-variable out }/scripts/record ${ environment-variable "COMMAND" } false ${ environment-variable "ARGUMENTS" } ${ environment-variable "STANDARD_INPUT" } ${ environment-variable "ABSOLUTE" } false > /dev/null &&
                                                                                                            ${ environment-variable out }/scripts/record ${ environment-variable "COMMAND" } true ${ environment-variable "ARGUMENTS" } ${ environment-variable "STANDARD_INPUT" } ${ environment-variable "ABSOLUTE" } false > /dev/null
                                                                                                    '' ;
                                                                                            temporary =
                                                                                                { pkgs , ... } : target :
                                                                                                    ''
