                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    assert_equals ${ environment-variable "EXPECTED_03_LOG" } ${ environment-variable "OBSERVED_03_LOG" } "We expect the log of the idential one to match." &&
                                                                                                                                                    ...
                                                                                                                                                    ${ if has-standard-input then "" else "# " }assert_matches ${ environment-variable "EXPECTED_06_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_06_STANDARD_OUTPUT" } "We expect the standard output of the comparison one (except standard input) to match." &&
                                                                                                                                                    ${ if has-standard-input then "" else "# " }${ computed-assertion } "${ environment-variable "EXPECTED_06_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_06_STANDARD_ERROR" }" "We expect the standard error of the comparison one (except standard input) to match." &&
                                                                                                                                                    ${ if has-standard-input then "" else "#" } assert_equals ${ environment-variable "EXPECTED_06_LOG" } ${ environment-variable "OBSERVED_06_LOG" } "We expect the log of the comparison one (except standard input) to match." &&
