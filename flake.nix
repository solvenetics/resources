                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    EXPECTED_03_LOG=${ if delta then "XXXX" else "_init_init_init" } &&
                                                                                                                                                    ...
                                                                                                                                                    EXPECTED_05_LOG=${ environment-variable "EXPECTED_03_LOG" } &&
                                                                                                                                                    ...
                                                                                                                                                    EXPECTED_06_LOG=${ environment-variable "EXPECTED_03_LOG" } &&
                                                                                                                                                    ...
                                                                                                                                                    EXPECTED_07_LOG=${ environment-variable "EXPECTED_03_LOG" } &&
                                                                                                                                                    ...
                                                                                                                                                    OBSERVED_06_LOG=$( ${ pkgs.coreutils }/bin/cat $( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } 06 standard output file ) ) ) &&
                                                                                                                                                    ...
                                                                                                                                                    assert_equals ${ environment-variable "EXPECTED_04_LOG" } ${ environment-variable "OBSERVED_04_LOG" } &&
                                                                                                                                                    ...
                                                                                                                                                    # assert_equals ${ environment-variable "EXPECTED_05_LOG" } ${ environment-variable "OBSERVED_05_LOG" } &&
                                                                                                                                                    assert_matches ${ environment-variable "EXPECTED_06_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_06_STANDARD_OUTPUT" } "YESfgsdfg" &&
                                                                                                                                                    ${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_06_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_06_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    # assert_equals ${ environment-variable "EXPECTED_06_LOG" } ${ environment-variable "OBSERVED_06_LOG" } &&
                                                                                                                                                    ...
                                                                                                                                                    # assert_equals ${ environment-variable "EXPECTED_07_LOG" } ${ environment-variable "OBSERVED_07_LOG" } &&
