                                                                                                        ...
                                                                                                        COMMAND=${ environment-variable 1 } &&
                                                                                                            ...
                                                                                                            then
                                                                                                                PRE_CAT_DIRECTORY=${ environment-variable "ABSOLUTE" }/pre.cat &&
                                                                                                                    ...
                                                                                                                    ${ environment-variable out }/scripts/directory ${ environment-variable "INPUT" } ${ environment-variable "PRE_CAT_DIRECTORY" } ${ environment-variable "PRE_STAT_DIRECTORY" } ${ environment-variable "ERROR_FLAG" } > /dev/null 2>&1 &&
