                                                                                                                             ...
                                                                                                                             delta : has-standard-input : arguments : standard-input :
                                                                                                                                ''
                                                                                                                                    COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                        ...
                                                                                                                                        EXPECTED_IDENTITY=$( ${ scripts.util.identity } ) &&
                                                                                                                                        ...
                                                                                                                                        EXPECTED_SCRIPTS_FILE="test=${ environment-variable out }/scripts/test,util.identity=${ environment-variable out }/scripts/util/identity,util.write=${ environment-variable out }/scripts/util/write,verification.bad=${ environment-variable out }/scripts/verification/bad,verification.good=${ environment-variable out }/scripts/verification/good,verification.terminal=${ environment-variable out }/scripts/verification/terminal" &&
                                                                                                                                        # EXPECTED_NO_SCRIPT_ARGUMENTS=$( IDENTITY=${ environment-variable "EXPECTED_IDENTITY" } ${ scripts.util.identity } no-script arguments ) &&
                                                                                                                                        # EXPECTED_NO_SCRIPT_IDENTITY=$( ARGUMENTS=${ environment-variable "EXPECTED_NO_SCRIPT_ARGUMENTS" } STANDARD_INPUT="" ${ scripts.util.identity } ) &&
                                                                                                                                        #
                                                                                                                                        ...
                                                                                                                                        OBSERVED_IDENTITY=$( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } file ) ) &&
                                                                                                                                        ...
                                                                                                                                        # OBSERVED_NO_SCRIPT_ARGUMENTS=$( ${ pkgs.coreutils }/bin/cat /build/$( IDENTITY=${ environment-variable "EXPECTED_IDENTITY" } ${ scripts.util.identity } no-script arguments file ) ) &&
                                                                                                                                        # OBSERVED_NO_SCRIPT_IDENTITY=$( ${ pkgs.coreutils }/bin/cat /build/$( ARGUMENTS=${ environment-variable "EXPECTED_NO_SCRIPT_ARGUMENTS" } STANDARD_INPUT="" ${ scripts.util.identity } file ) ) &&
                                                                                                                                        ...
                                                                                                                                        # assert_equals ${ environment-variable "EXPECTED_NO_SCRIPT_IDENTITY" } ${ environment-variable "OBSERVED_NO_SCRIPT_IDENTITY" } "We expect the predicted identity to no-script" &&
                                                                                                                                        #
                                                                                                        ...
                                                                                                        status : { pkgs , ... } : { environment-variable , has-standard-input , scripts , ... } :
                                                                                                            ''
                                                                                                                export ARGUMENTS=${ environment-variable "@" } &&
                                                                                                                    ...
                                                                                                                    ${ scripts.verification.terminal } ${ environment-variable "NO_SCRIPT_ARGUMENTS" } > >( ${ scripts.util.write } /build/$( ${ scripts.util.identity } no-script standard output ) ) 2> >( ${ scripts.util.write } /build/$( ${ scripts.util.identity } no-script standard error ) ) &&
