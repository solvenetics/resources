                                                                                                     ...
                                                                                                     test_temporary ( )
                                                                                                        {
                                                                                                            para_script ${ scripts.verification.temporary.init.bad } true 72 /build/LuSCtrEw.confirm rtw_rlc_txc_hgb_wmp_smf_bww_zpp_ txc smf epz vdl &&
                                                                                                                ...
                                                                                                                para_temporary_order ${ temporary.bad.null } true txc smf 90 /build/ODb8uwnZ.confirm "" &&
                                                                                                                ...
                                                                                                                para_temporary_order ${ temporary.bad.null } false txc smf 90 /build/ODb8uwnZ.confirm "" &&
