                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    ${ computed-assertion } "${ environment-variable "EXPECTED_01_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_01_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    ...
                                                                                                                                                    ${ computed-assertion } "${ environment-variable "EXPECTED_02_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_02_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    ...
                                                                                                                                                    ${ computed-assertion } "${ environment-variable "EXPECTED_03_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_03_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    ...
                                                                                                                                                    ${ computed-assertion } "${ environment-variable "EXPECTED_04_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_04_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    ...
                                                                                                                                                    ${ computed-assertion } "${ environment-variable "EXPECTED_05_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_05_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    ...
                                                                                                                                                    ${ if has-standard-input then "" else "# " }${ computed-assertion } "${ environment-variable "EXPECTED_06_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_06_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    ...
                                                                                                                                                    ${ computed-assertion } "${ environment-variable "EXPECTED_07_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_07_STANDARD_ERROR" }" "YES" &&
