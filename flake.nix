                                                                                                                             ...
                                                                                                                             delta : has-standard-input : arguments : standard-input :
                                                                                                                                ''
                                                                                                                                    COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                        ...
                                                                                                                                        EXPECTED_NO_SCRIPT_STANDARD_OUTPUT=$( IDENTITY=${ environment-variable "EXPECTED_NO_SCRIPT_IDENTITY" } ${ scripts.util.identity } ) &&
                                                                                                                                        ...
                                                                                                                                        # OBSERVED_NO_SCRIPT_STANDARD_OUTPUT=$( ${ pkgs.coreutils }/bin/cat /build/$( IDENTITY=${ environment-variable "EXPECTED_IDENTITY" } ${ scripts.util.identity } standard output ) ) &&
