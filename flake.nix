                                                                                                                            ...
                                                                                                                            let
                                                                                                                                        ...
                                                                                                                                        let
                                                                                                                                            command =
                                                                                                                                                let
                                                                                                                                                    ...
                                                                                                                                                    in builtins.getAttr ( if speed then "fast" else "slow" ) ( builtins.getAttr ( to-string release ) ( builtins.getAttr ( to-string init ) cache.verification ) ) ;
                                                                                                                                            ...
                                                                                                                                            computed-logs =
                                                                                                                                                let
                                                                                                                                                    # We have identified a hole in our testing.  The second condition below is a kludge.
                                                                                                                                                    blank = x : if x == "" then "_" else if builtins.typeOf init == "null" then "_" else x ;
                                                                                                                                                    ...
                                                                                                                                                    log-03 = builtins.concatStringsSep "" [ log-02 log-02 ] ;
                                                                                                                                                    in
                                                                                                                                                        {
                                                                                                                                                            log-01 = blank log-01 ;
                                                                                                                                                            log-02 = blank log-02 ;
                                                                                                                                                ...
                                                                                                                                                if has-standard-input then
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        invocation =
                                                                                                                                                            strip
                                                                                                                                                                ''
                                                                                                                                                                    assert_status_code ${ environment-variable "EXPECTED_STATUS" } "${ if has-standard-input then "${ pkgs.coreutils }/bin/echo ${ environment-variable "STANDARD_INPUT" } 06 | " else "" }${ environment-variable "COMMAND" } ${ environment-variable "ARGUMENTS" } 06 > /build/$( ${ scripts.util.identity } 06 standard output file ) 2> /build/$( ${ scripts.util.identity } 06 standard error file )" "identical to the comparison one except for different standard input"
                                                                                                                                                                '' ;
                                                                                                                                                        observeds =
                                                                                                                                                            strip
                                                                                                                                                                ''
                                                                                                                                                                    ...
                                                                                                                                                                    OBSERVED_06_LOG=$( read_log /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 06" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 06" else "" }" ${ scripts.util.identity } ) )
                                                                                                                                                                '' ;
                                                                                                                                                    }
                                                                                                                                                else
                                                                                                                                                    {
                                                                                                                                                            ...
                                                                                                                                                            read_log ( )
                                                                                                                                                                {
                                                                                                                                                                    NAME=${ environment-variable "@" } &&
                                                                                                                                                                        if [ -f ${ environment-variable "NAME" } ]
                                                                                                                                                                        then
                                                                                                                                                                            ${ pkgs.coreutils }/bin/cat ${ environment-variable "NAME" }
                                                                                                                                                                        elif [ -e ${ environment-variable "NAME" } ]
                                                                                                                                                                        then
                                                                                                                                                                            ${ pkgs.coreutils }/bin/echo NAME ${ environment-variable "NAME" } exists but it is not a file. >&2 &&
                                                                                                                                                                                exit 66
                                                                                                                                                                        else
                                                                                                                                                                            ${ pkgs.coreutils }/bin/echo _
                                                                                                                                                                        fi
                                                                                                                                                                } &&
                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                                    ...
                                                                                                                                                    EXPECTED_SCRIPTS_FILE="cache.evictors.fast=${ environment-variable out }/cache/evictors/fast,cache.evictors.slow=${ environment-variable out }/cache/evictors/slow,cache.log=${ environment-variable out }/cache/log,cache.null=${ environment-variable out }/cache/null,cache.verification.bad.bad.fast=${ environment-variable out }/cache/verification/bad/bad/fast,cache.verification.bad.bad.slow=${ environment-variable out }/cache/verification/bad/bad/slow,cache.verification.bad.good.fast=${ environment-variable out }/cache/verification/bad/good/fast,cache.verification.bad.good.slow=${ environment-variable out }/cache/verification/bad/good/slow,cache.verification.good.bad.fast=${ environment-variable out }/cache/verification/good/bad/fast,cache.verification.good.bad.slow=${ environment-variable out }/cache/verification/good/bad/slow,cache.verification.good.good.fast=${ environment-variable out }/cache/verification/good/good/fast,cache.verification.good.good.slow=${ environment-variable out }/cache/verification/good/good/slow,scripts.test=${ environment-variable out }/scripts/test,scripts.util.identity=${ environment-variable out }/scripts/util/identity,scripts.util.write=${ environment-variable out }/scripts/util/write,scripts.verification.bad=${ environment-variable out }/scripts/verification/bad,scripts.verification.cache.init.bad.fast=${ environment-variable out }/scripts/verification/cache/init/bad/fast,scripts.verification.cache.init.bad.slow=${ environment-variable out }/scripts/verification/cache/init/bad/slow,scripts.verification.cache.init.good.fast=${ environment-variable out }/scripts/verification/cache/init/good/fast,scripts.verification.cache.init.good.slow=${ environment-variable out }/scripts/verification/cache/init/good/slow,scripts.verification.cache.release.bad.fast=${ environment-variable out }/scripts/verification/cache/release/bad/fast,scripts.verification.cache.release.bad.slow=${ environment-variable out }/scripts/verification/cache/release/bad/slow,scripts.verification.cache.release.good.fast=${ environment-variable out }/scripts/verification/cache/release/good/fast,scripts.verification.cache.release.good.slow=${ environment-variable out }/scripts/verification/cache/release/good/slow,scripts.verification.evictors.init=${ environment-variable out }/scripts/verification/evictors/init,scripts.verification.evictors.release=${ environment-variable out }/scripts/verification/evictors/release,scripts.log=${ environment-variable out }/scripts/log,scripts.verification.good=${ environment-variable out }/scripts/verification/good,scripts.verification.temporary.init.bad=${ environment-variable out }/scripts/verification/temporary/init/bad,scripts.verification.temporary.init.good=${ environment-variable out }/scripts/verification/temporary/init/good,scripts.verification.temporary.release.bad=${ environment-variable out }/scripts/verification/temporary/release/bad,scripts.verification.temporary.release.good=${ environment-variable out }/scripts/verification/temporary/release/good,scripts.verification.terminal=${ environment-variable out }/scripts/verification/terminal,temporary.cache.bad.bad.fast=${ environment-variable out }/temporary/cache/bad/bad/fast,temporary.cache.bad.bad.slow=${ environment-variable out }/temporary/cache/bad/bad/slow,temporary.cache.bad.good.fast=${ environment-variable out }/temporary/cache/bad/good/fast,temporary.cache.bad.good.slow=${ environment-variable out }/temporary/cache/bad/good/slow,temporary.cache.good.bad.fast=${ environment-variable out }/temporary/cache/good/bad/fast,temporary.cache.good.bad.slow=${ environment-variable out }/temporary/cache/good/bad/slow,temporary.cache.good.good.fast=${ environment-variable out }/temporary/cache/good/good/fast,temporary.cache.good.good.slow=${ environment-variable out }/temporary/cache/good/good/slow,temporary.evictor=${ environment-variable out }/temporary/evictor,temporary.log=${ environment-variable out }/temporary/log,temporary.null=${ environment-variable out }/temporary/null,temporary.verification.bad.bad=${ environment-variable out }/temporary/verification/bad/bad,temporary.verification.bad.good=${ environment-variable out }/temporary/verification/bad/good,temporary.verification.bad.null=${ environment-variable out }/temporary/verification/bad/null,temporary.verification.good.bad=${ environment-variable out }/temporary/verification/good/bad,temporary.verification.good.good=${ environment-variable out }/temporary/verification/good/good,temporary.verification.good.null=${ environment-variable out }/temporary/verification/good/null,temporary.verification.null.bad=${ environment-variable out }/temporary/verification/null/bad,temporary.verification.null.good=${ environment-variable out }/temporary/verification/null/good,temporary.verification.null.null=${ environment-variable out }/temporary/verification/null/null" &&
                                                                                                                                                    EXPECTED_SCRIPTS_FILE="cache.evictors.fast=${ environment-variable out }/cache/evictors/fast,cache.evictors.slow=${ environment-variable out }/cache/evictors/slow,cache.log=${ environment-variable out }/cache/log,cache.null=${ environment-variable out }/cache/null,cache.verification.bad.bad.fast=${ environment-variable out }/cache/verification/bad/bad/fast,cache.verification.bad.bad.slow=${ environment-variable out }/cache/verification/bad/bad/slow,cache.verification.bad.good.fast=${ environment-variable out }/cache/verification/bad/good/fast,cache.verification.bad.good.slow=${ environment-variable out }/cache/verification/bad/good/slow,cache.verification.good.bad.fast=${ environment-variable out }/cache/verification/good/bad/fast,cache.verification.good.bad.slow=${ environment-variable out }/cache/verification/good/bad/slow,cache.verification.good.good.fast=${ environment-variable out }/cache/verification/good/good/fast,cache.verification.good.good.slow=${ environment-variable out }/cache/verification/good/good/slow,scripts.test=${ environment-variable out }/scripts/test,scripts.util.identity=${ environment-variable out }/scripts/util/identity,scripts.util.write=${ environment-variable out }/scripts/util/write,scripts.verification.bad=${ environment-variable out }/scripts/verification/bad,scripts.verification.cache.init.bad.fast=${ environment-variable out }/scripts/verification/cache/init/bad/fast,scripts.verification.cache.init.bad.slow=${ environment-variable out }/scripts/verification/cache/init/bad/slow,scripts.verification.cache.init.good.fast=${ environment-variable out }/scripts/verification/cache/init/good/fast,scripts.verification.cache.init.good.slow=${ environment-variable out }/scripts/verification/cache/init/good/slow,scripts.verification.cache.release.bad.fast=${ environment-variable out }/scripts/verification/cache/release/bad/fast,scripts.verification.cache.release.bad.slow=${ environment-variable out }/scripts/verification/cache/release/bad/slow,scripts.verification.cache.release.good.fast=${ environment-variable out }/scripts/verification/cache/release/good/fast,scripts.verification.cache.release.good.slow=${ environment-variable out }/scripts/verification/cache/release/good/slow,scripts.verification.evictors.init=${ environment-variable out }/scripts/verification/evictors/init,scripts.verification.evictors.release=${ environment-variable out }/scripts/verification/evictors/release,scripts.verification.good=${ environment-variable out }/scripts/verification/good,scripts.verification.log=${ environment-variable out }/scripts/verification/log,scripts.verification.temporary.init.bad=${ environment-variable out }/scripts/verification/temporary/init/bad,scripts.verification.temporary.init.good=${ environment-variable out }/scripts/verification/temporary/init/good,scripts.verification.temporary.release.bad=${ environment-variable out }/scripts/verification/temporary/release/bad,scripts.verification.temporary.release.good=${ environment-variable out }/scripts/verification/temporary/release/good,scripts.verification.terminal=${ environment-variable out }/scripts/verification/terminal,temporary.cache.bad.bad.fast=${ environment-variable out }/temporary/cache/bad/bad/fast,temporary.cache.bad.bad.slow=${ environment-variable out }/temporary/cache/bad/bad/slow,temporary.cache.bad.good.fast=${ environment-variable out }/temporary/cache/bad/good/fast,temporary.cache.bad.good.slow=${ environment-variable out }/temporary/cache/bad/good/slow,temporary.cache.good.bad.fast=${ environment-variable out }/temporary/cache/good/bad/fast,temporary.cache.good.bad.slow=${ environment-variable out }/temporary/cache/good/bad/slow,temporary.cache.good.good.fast=${ environment-variable out }/temporary/cache/good/good/fast,temporary.cache.good.good.slow=${ environment-variable out }/temporary/cache/good/good/slow,temporary.evictor=${ environment-variable out }/temporary/evictor,temporary.log=${ environment-variable out }/temporary/log,temporary.null=${ environment-variable out }/temporary/null,temporary.verification.bad.bad=${ environment-variable out }/temporary/verification/bad/bad,temporary.verification.bad.good=${ environment-variable out }/temporary/verification/bad/good,temporary.verification.bad.null=${ environment-variable out }/temporary/verification/bad/null,temporary.verification.good.bad=${ environment-variable out }/temporary/verification/good/bad,temporary.verification.good.good=${ environment-variable out }/temporary/verification/good/good,temporary.verification.good.null=${ environment-variable out }/temporary/verification/good/null,temporary.verification.null.bad=${ environment-variable out }/temporary/verification/null/bad,temporary.verification.null.good=${ environment-variable out }/temporary/verification/null/good,temporary.verification.null.null=${ environment-variable out }/temporary/verification/null/null" &&
                                                                                                                                                ...
                                                                                                                                                strip
                                                                                                                                                    ''
                                                                                                                                                        export COMMAND=${ command } &&
                                                                                                                                                            ...
                                                                                                                                                            then
                                                                                                                                                                if [ ${ environment-variable "?" } != ${ environment-variable "EXPECTED_STATUS" } ]
                                                                                                                                                                then
                                                                                                                                                                    fail "The process succeed but the status did not match."
                                                                                                                                                                fi
                                                                                                                                                            else
                                                                                                                                                                if [ ${ environment-variable "?" } != ${ environment-variable "EXPECTED_STATUS" } ]
                                                                                                                                                                then
                                                                                                                                                            ...
                                                                                                                                                            OBSERVED_01_LOG=$( read_log /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 01" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 01" else "" }" ${ scripts.util.identity } ) ) &&
                                                                                                                                                            ...
                                                                                                                                                            OBSERVED_02_LOG=$( read_log /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 02" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 02" else "" }" ${ scripts.util.identity } ) ) &&
                                                                                                                                                            ...
                                                                                                                                                            OBSERVED_03_LOG=$( read_log /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 03" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 03" else "" }" ${ scripts.util.identity } ) ) &&
                                                                                                                                                            ...
                                                                                                                                                            OBSERVED_04_LOG=$( read_log /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 03" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 03" else "" }" ${ scripts.util.identity } ) ) &&
                                                                                                                                                            ...
                                                                                                                                                            OBSERVED_05_LOG=$( read_log /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 05" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 03" else "" }" ${ scripts.util.identity } ) ) &&
                                                                                                                                                            ...
                                                                                                                                                            OBSERVED_07_LOG=$( read_log /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 07" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 07" else "" }" ${ scripts.util.identity } ) ) &&
                                                                                                                                ...
                                                                                                                                in
                                                                                                                                    [
                                                                                                                                        ...
                                                                                                                                        ( temp true null true )
                                                                                                                                        # We have identified a hole in testing.  Since the init method creates the log file based on argument and standard input and the release file does not have access to those things, when we choose null for init the log is going to be messed up.  That is unavoidable with the current design.
                                                                                                                                        ( temp null false false )
                                                                                                                                        ( temp null false true )
                                                                                                                                        ( temp null true false )
                                                                                                                                        ( temp null true true )
                                                                                                                                        # The hole extends to here.
                                                                                                                            ...
                                                                                                                            init =
                                                                                                                                {
                                                                                                                                    bad =
                                                                                                                                        {
                                                                                                                                            fast = cache false "init" 68 ;
                                                                                                                                            slow = cache true "init" 69 ;
                                                                                                                                        } ;
                                                                                                                                    good =
                                                                                                                                        {
                                                                                                                                            fast = cache false "init" 0 ;
                                                                                                                                            slow = cache true "init" 0 ;
                                                                                                                                        } ;
                                                                                                                                } ;
                                                                                                                            release =
                                                                                                                                {
                                                                                                                                    bad =
                                                                                                                                        {
                                                                                                                                            fast = cache false "release" 70 ;
                                                                                                                                            slow = cache false "release" 71 ;
                                                                                                                                        } ;
                                                                                                                                    good =
                                                                                                                                        {
                                                                                                                                            fast = cache false "release" 0 ;
                                                                                                                                            slow = cache true "release" 0 ;
                                                                                                                                        } ;
                                                                                                                                } ;
                                                                                                                        } ;
                                                                                                                    evictors =
                                                                                        ...
                                                                                        temporary =
                                                                                            {
                                                                                                ...
                                                                                                evictor = scripts : { init = scripts.verification.evictors.init ; release = scripts.verification.evictors.release ; } ;
                                                                                                log = scripts : { } ;
