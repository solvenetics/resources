                                                                                                                                ...
                                                                                                                                strip
                                                                                                                                    ''
                                                                                                                                        COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                            ...
                                                                                                                                            EXPECTED_NO_TEMPORARY_STANDARD_OUTPUT=$( ARGUMENTS=${ environment-variable "EXPECTED_NO_TEMPORARY_ARGUMENTS" } STANDARD_INPUT="" ${ scripts.util.identity } standard output ) &&
                                                                                                                                            EXPECTED_NO_TEMPORARY_STANDARD_ERROR=$( ARGUMENTS=${ environment-variable "EXPECTED_NO_TEMPORARY_ARGUMENTS" } STANDARD_INPUT="" ${ scripts.util.identity } standard error ) &&
                                                                                                                                            ...
                                                                                                                                            assert_equals ${ environment-variable "EXPECTED_NO_SCRIPT_ARGUMENTS" } ${ environment-variable "OBSERVED_NO_SCRIPT_ARGUMENTS" } "We expect the predicted argument to no-temporary." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_NO_SCRIPT_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_NO_SCRIPT_STANDARD_OUTPUT" } "We expect the predicted standard output to no-temporary." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_NO_SCRIPT_STANDARD_ERROR" } ${ environment-variable "OBSERVED_NO_SCRIPT_STANDARD_ERROR" } "We expect the predicted standard error to no-temporary." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_NO_SCRIPT_TEMPORARY_FILE" } ${ environment-variable "OBSERVED_NO_SCRIPT_TEMPORARY_FILE" } "We expect the predicted scripts to be available to the NO_SCRIPT." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_NO_SCRIPT_STRIP" } ${ environment-variable "OBSERVED_NO_SCRIPT_STRIP" } "We expect the the predicted strip value to the NO_SCRIPT." &&
                                                                                                                                            # assert_equals "${ environment-variable "EXPECTED_NO_TEMPORARY_TARGET" }" "${ environment-variable "OBSERVED_NO_SCRIPT_TARGET" }" "We expected the NO_SCRIPT target to be blank." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_YES_SCRIPT_ARGUMENTS" } ${ environment-variable "OBSERVED_YES_SCRIPT_ARGUMENTS" } "We expect the predicted argument to yes-temporary." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_YES_SCRIPT_STANDARD_INPUT" } ${ environment-variable "OBSERVED_YES_SCRIPT_STANDARD_INPUT" } "We expect the predicted standard input to yes-temporary." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_YES_SCRIPT_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_YES_SCRIPT_STANDARD_OUTPUT" } "We expect the predicted standard output to yes-temporary." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_YES_SCRIPT_STANDARD_ERROR" } ${ environment-variable "OBSERVED_YES_SCRIPT_STANDARD_ERROR" } "We expect the predicted standard error to yes-temporary." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_YES_SCRIPT_TEMPORARY_FILE" } ${ environment-variable "OBSERVED_YES_SCRIPT_TEMPORARY_FILE" } "We expect the predicted scripts to be available to the yes_SCRIPT." &&
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_YES_SCRIPT_STRIP" } ${ environment-variable "OBSERVED_YES_SCRIPT_STRIP" } "We expect the the predicted strip value to the yes_SCRIPT." &&
                                                                                                                                            # assert_equals "${ environment-variable "EXPECTED_YES_TEMPORARY_TARGET" }" "${ environment-variable "OBSERVED_YES_SCRIPT_TARGET" }" "We expected the yes_SCRIPT target to be blank."
                                                                                                                                            true
                                                                                                                                    '' ;
                                                                                                                        in
                                                                                                                            [
