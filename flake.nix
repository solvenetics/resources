                                                                                                ...
                                                                                                { pkgs , ... } : target :
                                                                                                    ''
                                                                                                       COMMAND=${ environment-variable 1 } &&
                                                                                                            ...
                                                                                                            ${ pkgs.coreutils }/bin/echo ${ environment-variable out }/scripts/post-operate ${ environment-variable "INPUT_1" }${ environment-variable "ABSOLUTE" }/1.post.move move_self | ${ at } now &&
