                                                                                                                                                ...
                                                                                                                                                strip
                                                                                                                                                    ''
                                                                                                                                                        export COMMAND=${ command } &&
                                                                                                                                                            ...
                                                                                                                                                            assert_status_code ${ environment-variable "EXPECTED_STATUS" } "${ if has-standard-input then "${ pkgs.coreutils }/bin/echo ${ environment-variable "STANDARD_INPUT" } 001-000 | " else "" }${ environment-variable "COMMAND" } ${ environment-variable "ARGUMENTS" } 001-012 > /build/$( ${ scripts.util.identity } standard output file 001-012 ) 2> /build/$( ${ scripts.util.identity } standard error file 001-012 )" "model one" &&
                                                                                                                                                            ...
                                                                                                                                                            ${ pkgs.coreutils }/bin/sleep $(( inc + $( ${ pkgs.coreutils }/bin/date +%s ) - ${ environment-variable "T0" } )) &&
