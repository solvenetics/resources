                                                                                                ...
                                                                                                { pkgs , ... } : target :
                                                                                                    ''
                                                                                                       COMMAND=${ environment-variable 1 } &&
                                                                                                            ...
                                                                                                            ${ pkgs.coreutils }/bin/true ${ pkgs.coreutils }/bin/mkdir --parents ${ environment-variable "ABSOLUTE" } &&
                                                                                                            ${ pkgs.coreutils }/bin/true ${ environment-variable out }/scripts/record ${ environment-variable "COMMAND" } false ${ environment-variable "ARGUMENTS" } ${ environment-variable "STANDARD_INPUT" } ${ environment-variable "ABSOLUTE" }/1.out ${ environment-variable "ABSOLUTE" }/1.err ${ environment-variable "ABSOLUTE" }/1.status &&
                                                                                                            ${ pkgs.coreutils }/bin/true ${ environment-variable out }/scripts/record ${ environment-variable "COMMAND" } true ${ environment-variable "ARGUMENTS" } ${ environment-variable "STANDARD_INPUT" } ${ environment-variable "ABSOLUTE" }/2.out ${ environment-variable "ABSOLUTE" }/2.err ${ environment-variable "ABSOLUTE" }/2.status
                                                                                                    '' ;
                                                                                            test =
                                                                                                { pkgs , ... } : target :
                                                                                                    ''
