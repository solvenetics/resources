                                                                                                                             ...
                                                                                                                             delta : has-standard-input : arguments : standard-input :
                                                                                                                                ''
                                                                                                                                    COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                        ...
                                                                                                                                        EXPECTED_NO_SCRIPTS_IDENTITY=$( ARGUMENTS=$( ${ scripts.util.hash } ${ environment-variable "EXPECTED_IDENTITY" } no-script argument ) STANDARD_INPUT="" ${ scripts.util.identity } ) &&
