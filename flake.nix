                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    EXPECTED_ALPHA_STANDARD_OUTPUT=${ if builtins.typeOf init == "bool" && ! init then "\/build\/[a-zA-Z0-9]{8}\.broken\/target" else "\/build\/[a-zA-Z0-9]{8}\.resource\/target" } &&
                                                                                                                                                    EXPECTED_ALPHA_STANDARD_ERROR=${ if builtins.typeOf init == "bool" && ! init then "" else "" } &&
                                                                                                                                                    ...
                                                                                                                                                    ## assert_equals ${ environment-variable "EXPECTED_ALPHA_STANDARD_ERROR" } "${ environment-variable "OBSERVED_ALPHA_STANDARD_ERROR" }" "YES"
                                                                                                                                                    true
                                                                                                                                            '' ;
                                                                                                                        in
                                                                                                                            [
