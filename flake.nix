                                                                                                                                ...
                                                                                                                                strip
                                                                                                                                    ''
                                                                                                                                        COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                            ...
                                                                                                                                            # assert_equals ${ environment-variable "EXPECTED_NO_TEMPORARY_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_NO_TEMPORARY_STANDARD_OUTPUT" } "We expect the predicted standard output to no-script." &&
                                                                                                                                            ...
                                                                                                                                            # assert_equals "${ environment-variable "EXPECTED_NO_SCRIPTS_TARGET" }" "${ environment-variable "OBSERVED_NO_TEMPORARY_TARGET" }" "We expected the NO_SCRIPT target to be blank." &&
