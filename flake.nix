                                                                                                ...
                                                                                                { pkgs , ... } : target :
                                                                                                    ''
                                                                                                       COMMAND=${ environment-variable 1 } &&
                                                                                                            ...
                                                                                                            ${ pkgs.coreutils }/bin/mkdir --parents ${ environment-variable "ABSOLUTE" } &&
                                                                                                            ${ environment-variable out }/scripts/record ${ environment-variable "COMMAND" } false $( ${ environment-variable out }/scripts/sha512 ${ environment-variable "ARGUMENTS" } temporary false ) $( ${ environment-variable out }/scripts/sha512 ${ environment-variable "STANDARD_INPUT" } temporary false ) ${ environment-variable "ABSOLUTE" }/false false &&
                                                                                                            ${ environment-variable out }/scripts/record ${ environment-variable "COMMAND" } true $( ${ environment-variable out }/scripts/sha512 ${ environment-variable "ARGUMENTS" } temporary true ) $( ${ environment-variable out }/scripts/sha512 ${ environment-variable "STANDARD_INPUT" } temporary true ) ${ environment-variable "ABSOLUTE" }/true false
                                                                                                    '' ;
                                                                                            test =
                                                                                                { pkgs , ... } : target :
                                                                                                    ''
