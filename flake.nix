                                                                                    ...
                                                                                    in
                                                                                        ''
                                                                                            RESOURCE=$( ${ temporary-resource-directory } ) &&
                                                                                                ...
                                                                                                if [ ${ environment-variable "STATUS" } == 0 ]
                                                                                                then
                                                                                                    ${ pkgs.coreutils }/bin/echo -n __RELEASE_1 >> /build/debug &&
                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    OBSERVED_02_1_LOG_FILE=/build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" } 02" STANDARD_INPUT="${ if has-standard-input then "${ environment-variable "STANDARD_INPUT" } 02" else "" }" ${ scripts.util.identity } ) &&
                                                                                                                                                    OBSERVED_02_LOG=$( ${ pkgs.coreutils }/bin/cat ${ environment-variable "OBSERVED_02_1_LOG_FILE" } ) &&
