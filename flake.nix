                                                                                                                        ...
                                                                                                                        temp =
                                                                                                                            init : release : has-standard-input : arguments : standard-input :
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    delta = if builtins.typeOf init == "bool" && ! init then false else true ;
                                                                                                                                    in
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    export STANDARD_INPUT=${ if has-standard-input then standard-input else "" } &&
                                                                                                                                                    EXPECTED_STATUS=${ builtins.toString ( if delta then 0 else 64 ) } &&
                                                                                                                                                    EXPECTED_01_STANDARD_OUTPUT=${ if delta then "\/build\/[a-zA-Z0-9]{8}\.resource\/target" else "\/build\/[a-zA-Z0-9]{8}\.broken\/target" } &&
                                                                                                                                                    EXPECTED_01_STANDARD_ERROR="${ if delta then "" else "We were unable to complete initiation:  \/build/[a-zA-Z0-9]{8}\.broken" }" &&
                                                                                                                                                    EXPECTED_01_LOG="_init" &&
                                                                                                                                                    EXPECTED_02_STANDARD_OUTPUT=${ if delta then "\/build\/[a-zA-Z0-9]{8}\.resource\/target" else "\/build\/[a-zA-Z0-9]{8}\.broken\/target" } &&
                                                                                                                                                    EXPECTED_02_STANDARD_ERROR="${ if delta then "" else "We were unable to complete initiation:  \/build/[a-zA-Z0-9]{8}\.broken" }" &&
                                                                                                                                                    EXPECTED_02_LOG=${ if delta then "_init_release" else "_init" } &&
                                                                                                                                                    EXPECTED_03_STANDARD_OUTPUT=${ if delta then "\/build\/[a-zA-Z0-9]{8}\.resource\/target" else "\/build\/[a-zA-Z0-9]{8}\.broken\/target" } &&
                                                                                                                                                    EXPECTED_03_STANDARD_ERROR="${ if delta then "" else "We were unable to complete initiation:  \/build/[a-zA-Z0-9]{8}\.broken" }" &&
                                                                                                                                                    EXPECTED_03_LOG=${ if delta then "XXXX" else "_init_init" } &&
                                                                                                                                                    EXPECTED_04_STANDARD_OUTPUT=${ if delta then "\/build\/[a-zA-Z0-9]{8}\.resource\/target" else "\/build\/[a-zA-Z0-9]{8}\.broken\/target" } &&
                                                                                                                                                    EXPECTED_04_STANDARD_ERROR="${ if delta then "" else "We were unable to complete initiation:  \/build/[a-zA-Z0-9]{8}\.broken" }" &&
                                                                                                                                                    EXPECTED_04_LOG=${ environment-variable "EXPECTED_03_LOG" } &&
                                                                                                                                                    EXPECTED_05_STANDARD_OUTPUT=${ if delta then "\/build\/[a-zA-Z0-9]{8}\.resource\/target" else "\/build\/[a-zA-Z0-9]{8}\.broken\/target" } &&
                                                                                                                                                    EXPECTED_05_STANDARD_ERROR="${ if delta then "" else "We were unable to complete initiation:  \/build/[a-zA-Z0-9]{8}\.broken" }" &&
                                                                                                                                                    EXPECTED_05_LOG=${ if delta then "_init" else "_init" } &&
                                                                                                                                                    EXPECTED_06_STANDARD_OUTPUT=${ if delta then "\/build\/[a-zA-Z0-9]{8}\.resource\/target" else "\/build\/[a-zA-Z0-9]{8}\.broken\/target" } &&
                                                                                                                                                    EXPECTED_06_STANDARD_ERROR="${ if delta then "" else "We were unable to complete initiation:  \/build/[a-zA-Z0-9]{8}\.broken" }" &&
                                                                                                                                                    EXPECTED_06_LOG=${ if delta then "_init" else "_init" } &&
                                                                                                                                                    EXPECTED_07_STANDARD_OUTPUT=${ if delta then "\/build\/[a-zA-Z0-9]{8}\.resource\/target" else "\/build\/[a-zA-Z0-9]{8}\.broken\/target" } &&
                                                                                                                                                    EXPECTED_07_STANDARD_ERROR="${ if delta then "" else "We were unable to complete initiation:  \/build/[a-zA-Z0-9]{8}\.broken" }" &&
                                                                                                                                                    EXPECTED_07_LOG=${ if delta then "_init" else "_init" } &&
                                                                                                                                                    EXPECTED_08_STANDARD_OUTPUT=${ if delta then "\/build\/[a-zA-Z0-9]{8}\.resource\/target" else "\/build\/[a-zA-Z0-9]{8}\.broken\/target" } &&
                                                                                                                                                    EXPECTED_08_STANDARD_ERROR="${ if delta then "" else "We were unable to complete initiation:  \/build/[a-zA-Z0-9]{8}\.broken" }" &&
                                                                                                                                                    EXPECTED_08_LOG=${ if delta then "_init" else "_init" } &&
                                                                                                                                                    ...
                                                                                                                                                    assert_status_code ${ environment-variable "EXPECTED_STATUS" } "${ pkgs.bash }/bin/bash -c \"${ if has-standard-input then "${ pkgs.coreutils }/bin/echo ${ environment-variable "STANDARD_INPUT" } 02 | " else "" }${ environment-variable "COMMAND" } ${ environment-variable "ARGUMENTS" } 02 > /build/$( ${ scripts.util.identity } 02 standard output file ) 2> /build/$( ${ scripts.util.identity } 02 standard error file )\"" &&
                                                                                                                                                    assert_status_code ${ environment-variable "EXPECTED_STATUS" } "${ pkgs.bash }/bin/bash -c \"${ if has-standard-input then "${ pkgs.coreutils }/bin/echo ${ environment-variable "STANDARD_INPUT" } 03 | " else "" }${ environment-variable "COMMAND" } ${ environment-variable "ARGUMENTS" } 03 > /build/$( ${ scripts.util.identity } 03 standard output file ) 2> /build/$( ${ scripts.util.identity } 03 standard error file )\"" &&
                                                                                                                                                    assert_status_code ${ environment-variable "EXPECTED_STATUS" } "${ pkgs.bash }/bin/bash -c \"${ if has-standard-input then "${ pkgs.coreutils }/bin/echo ${ environment-variable "STANDARD_INPUT" } 03 | " else "" }${ environment-variable "COMMAND" } ${ environment-variable "ARGUMENTS" } 03 > /build/$( ${ scripts.util.identity } 04 standard output file ) 2> /build/$( ${ scripts.util.identity } 04 standard error file )\"" &&
                                                                                                                                                    assert_status_code ${ environment-variable "EXPECTED_STATUS" } "${ pkgs.bash }/bin/bash -c \"${ if has-standard-input then "${ pkgs.coreutils }/bin/echo ${ environment-variable "STANDARD_INPUT" } 03 | " else "" }${ environment-variable "COMMAND" } ${ environment-variable "ARGUMENTS" } 05 > /build/$( ${ scripts.util.identity } 05 standard output file ) 2> /build/$( ${ scripts.util.identity } 05 standard error file )\"" &&
                                                                                                                                                    ${ if has-standard-input then "" else "# " }assert_status_code ${ environment-variable "EXPECTED_STATUS" } "${ pkgs.bash }/bin/bash -c \"${ if has-standard-input then "${ pkgs.coreutils }/bin/echo ${ environment-variable "STANDARD_INPUT" } 06 | " else "" }${ environment-variable "COMMAND" } ${ environment-variable "ARGUMENTS" } 03 > /build/$( ${ scripts.util.identity } 06 standard output file ) 2> /build/$( ${ scripts.util.identity } 06 standard error file )\"" &&
                                                                                                                                                    ...
                                                                                                                                                    OBSERVED_02_LOG=$( ${ pkgs.coreutils }/bin/cat $( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } 02 standard output file ) ) ) &&
                                                                                                                                                    ...
                                                                                                                                                    OBSERVED_03_LOG=$( ${ pkgs.coreutils }/bin/cat $( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } 03 standard output file ) ) ) &&
                                                                                                                                                    ...
                                                                                                                                                    OBSERVED_04_LOG=$( ${ pkgs.coreutils }/bin/cat $( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } 04 standard output file ) ) ) &&
                                                                                                                                                    ...
                                                                                                                                                    OBSERVED_05_LOG=$( ${ pkgs.coreutils }/bin/cat $( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } 05 standard output file ) ) ) &&
                                                                                                                                                    ${ if has-standard-input then "" else "# " }OBSERVED_06_STANDARD_OUTPUT=$( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } 06 standard output file ) ) &&
                                                                                                                                                    ${ if has-standard-input then "" else "# " }OBSERVED_06_STANDARD_ERROR=$( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } 06 standard error file ) ) &&
                                                                                                                                                    ${ if has-standard-input then "" else "# " }OBSERVED_06_LOG=$( ${ pkgs.coreutils }/bin/cat $( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } 06 standard output file ) ) ) &&
                                                                                                                                                    ...
                                                                                                                                                    assert_matches ${ environment-variable "EXPECTED_01_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_01_STANDARD_OUTPUT" } "YES" &&
                                                                                                                                                    ${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_01_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_01_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    assert_equals ${ environment-variable "EXPECTED_01_LOG" } ${ environment-variable "OBSERVED_01_LOG" } &&
                                                                                                                                                    assert_matches ${ environment-variable "EXPECTED_02_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_02_STANDARD_OUTPUT" } "YESfgsdfg" &&
                                                                                                                                                    ${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_02_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_02_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    assert_equals ${ environment-variable "EXPECTED_02_LOG" } ${ environment-variable "OBSERVED_02_LOG" } &&
                                                                                                                                                    assert_matches ${ environment-variable "EXPECTED_03_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_03_STANDARD_OUTPUT" } "YESfgsdfg" &&
                                                                                                                                                    ${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_03_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_03_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    assert_equals ${ environment-variable "EXPECTED_03_LOG" } ${ environment-variable "OBSERVED_03_LOG" } &&
                                                                                                                                                    assert_matches ${ environment-variable "EXPECTED_04_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_04_STANDARD_OUTPUT" } "YESfgsdfg" &&
                                                                                                                                                    ${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_04_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_04_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    assert_equals ${ environment-variable "EXPECTED_04_LOG" } ${ environment-variable "OBSERVED_04_LOG" } "4" &&
                                                                                                                                                    assert_matches ${ environment-variable "EXPECTED_05_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_05_STANDARD_OUTPUT" } "YESfgsdfg" &&
                                                                                                                                                    ${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_05_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_05_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    assert_equals ${ environment-variable "EXPECTED_05_LOG" } ${ environment-variable "OBSERVED_05_LOG" } "5" &&
                                                                                                                                                    ${ if has-standard-input then "" else "# " }assert_matches ${ environment-variable "EXPECTED_06_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_06_STANDARD_OUTPUT" } "YESfgsdfg" &&
                                                                                                                                                    ${ if has-standard-input then "" else "# " }${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_06_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_06_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    ${ if has-standard-input then "" else "#" } assert_equals ${ environment-variable "EXPECTED_06_LOG" } ${ environment-variable "OBSERVED_06_LOG" } "6" &&
                                                                                                                                                    assert_matches ${ environment-variable "EXPECTED_07_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_07_STANDARD_OUTPUT" } "YESfgsdfg" &&
                                                                                                                                                    ${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_07_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_07_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    assert_equals ${ environment-variable "EXPECTED_07_LOG" } ${ environment-variable "OBSERVED_07_LOG" }  "7" &&
                                                                                                                                                    # assert_matches ${ environment-variable "EXPECTED_08_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_08_STANDARD_OUTPUT" } "YESfgsdfg" &&
                                                                                                                                                    # ${ if delta then "assert_equals" else "assert_matches" } "${ environment-variable "EXPECTED_08_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_08_STANDARD_ERROR" }" "YES" &&
                                                                                                                                                    # assert_equals ${ environment-variable "EXPECTED_08_LOG" } ${ environment-variable "OBSERVED_08_LOG" }  "7" &&
