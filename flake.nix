                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    # assert_matches ${ environment-variable "EXPECTED_02_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_02_STANDARD_OUTPUT" } "YES" &&
