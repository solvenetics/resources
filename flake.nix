                                                                                                                                ...
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    computed-logs =
                                                                                                                                        let
                                                                                                                                            ...
                                                                                                                                            log-02 = builtins.concatStringsSep "" [ ( if builtins.typeOf init == "bool" then "_init" else "WRONG_B" ) ( if builtins.typeOf init == "bool" && init && builtins.typeOf release == "bool" then "_release" else "" ) ( if builtins.typeOf init == "null" && builtins.typeOf release == "bool" then "_release" else "" ) ] ;
