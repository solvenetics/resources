                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    assert_equals "${ environment-variable "EXPECTED_08_STANDARD_OUTPUT" }" "${ environment-variable "OBSERVED_08_STANDARD_OUTPUT" }" "YESfgsdfg" &&
                                                                                                                                                    assert_equals "${ environment-variable "EXPECTED_08_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_08_STANDARD_ERROR" }" "YES" &&
