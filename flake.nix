                                                                                                                             ...
                                                                                                                             delta : has-standard-input : arguments : standard-input :
                                                                                                                                ''
                                                                                                                                    COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                        ...
                                                                                                                                        EXPECTED_NO_SCRIPT_IDENTITY=$( ARGUMENTS=$( ${ scripts.util.hash } ${ environment-variable "EXPECTED_IDENTITY" } no-script argument ) STANDARD_INPUT="" ${ scripts.util.identity } ) &&
                                                                                                                                        ...
                                                                                                                                        OBSERVED_ARGUMENTS=$( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } arguments file ) ) &&
                                                                                                                                        OBSERVED_STANDARD_INPUT=$( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } standard input file ) ) &&
                                                                                                                                        OBSERVED_SCRIPTS_FILE=$( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } scripts file ) ) &&
                                                                                                                                        # OBSERVED_NO_SCRIPT_IDENTITY=$( ${ pkgs.coreutils }/bin/cat /build/=$( ARGUMENTS=$( ${ scripts.util.hash } ${ environment-variable "EXPECTED_IDENTITY" } no-script argument ) STANDARD_INPUT="" ${ scripts.util.identity } no-script standard output ) ) &&
                                                                                            ...
                                                                                            util =
                                                                                                {
                                                                                                    ...
                                                                                                    hash =
                                                                                                        { pkgs , ... } : { environment-variable , ... } :
                                                                                                            ''
                                                                                                                ${ pkgs.coreutils }/bin/sha512sum ${ environment-variable "@" } | ${ pkgs.coreutils }/bin/cut --bytes -128
                                                                                                            '' ;
                                                                                                    write =
                                                                                                        { pkgs , ... } : { environment-variable , ... } :
                                                                                                            ''
