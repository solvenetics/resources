                                                                                                                                        ...
                                                                                                                                        strip
                                                                                                                                            ''
                                                                                                                                                export COMMAND=${ command } &&
                                                                                                                                                    ...
                                                                                                                                                    # OBSERVED_02_LOG=$( ${ pkgs.coreutils }/bin/cat /build/$( ARGUMENTS="${ environment-variable "ARGUMENTS" }" STANDARD_INPUT="${ environment-variable "STANDARD_INPUT" }" ${ scripts.util.identity } ${ environment-variable "ARGUMENTS" } ${ environment-variable "STANDARD_INPUT" } ) ) &&
