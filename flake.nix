                                                                                                                             ...
                                                                                                                             delta : has-standard-input : arguments : standard-input :
                                                                                                                                ''
                                                                                                                                    COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                        ...
                                                                                                                                        OBSERVED_STRIP=$( ${ pkgs.coreutils }/bin/cat /build/$( ${ scripts.util.identity } target file ) ) &&
                                                                                                                                        ...
                                                                                                                                        assert_equals ${ environment-variable "EXPECTED_STRIP" } ${ environment-variable "OBSERVED_STRIP" } 
                                                                                                                                        ...
                                                                                                                                        assert_equals ${ environment-variable "EXPECTED_NO_SCRIPT_SCRIPTS_FILE" } ${ environment-variable "OBSERVED_NO_SCRIPT_SCRIPTS_FILE" } "We exec the predicted scripts to be available to the NO_SCRIPT." &&
                                                                                                                                        assert_equals "${ environment-variable "EXPECTED_NO_SCRIPTS_TARGET" }" "${ environment-variable "OBSERVED_NO_SCRIPTS_TARGET" }" "We expected the NO_SCRIPT target to be blank."
                                                                                                                                '' ;
                                                                                                                        in
                                                                                                                            [
                                                                                                                                ( script true true )
