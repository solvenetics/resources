                                                                                                                                ...
                                                                                                                                strip
                                                                                                                                    ''
                                                                                                                                        COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                            ...
                                                                                                                                            assert_equals ${ environment-variable "EXPECTED_YES_CACHE_ARGUMENTS" } ${ environment-variable "OBSERVED_YES_CACHE_ARGUMENTS" } "We expect the predicted argument to yes-script." &&
                                                                                                                                            assert_equals ${ environment-variable "EXPECTED_YES_CACHE_STANDARD_INPUT" } ${ environment-variable "OBSERVED_YES_CACHE_STANDARD_INPUT" } "We expect the predicted standard input to yes-script." &&
                                                                                                                                            assert_matches ${ environment-variable "EXPECTED_YES_CACHE_STANDARD_OUTPUT" } ${ environment-variable "OBSERVED_YES_CACHE_STANDARD_OUTPUT" } "We expect the predicted standard output to yes-script." &&
                                                                                                                                            assert_equals "${ environment-variable "EXPECTED_YES_CACHE_STANDARD_ERROR" }" "${ environment-variable "OBSERVED_YES_CACHE_STANDARD_ERROR" }" "We expect the predicted standard error to yes-script." &&
                                                                                                                                            assert_equals ${ environment-variable "EXPECTED_YES_CACHE_SCRIPTS_FILE" } ${ environment-variable "OBSERVED_YES_CACHE_SCRIPTS_FILE" } "We expect the predicted scripts to be available to the yes_SCRIPT." &&
                                                                                                                                            assert_equals ${ environment-variable "EXPECTED_YES_CACHE_STRIP" } ${ environment-variable "OBSERVED_YES_CACHE_STRIP" } "We expect the the predicted strip value to the yes_SCRIPT." &&
                                                                                                                                            assert_equals "${ environment-variable "OBSERVED_YES_CACHE_STANDARD_OUTPUT" }" "${ environment-variable "OBSERVED_YES_CACHE_TARGET" }" "We expected the yes_SCRIPT target to be blank."
