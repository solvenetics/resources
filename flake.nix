                                                                                                                             ...
                                                                                                                             delta : has-standard-input : arguments : standard-input :
                                                                                                                                ''
                                                                                                                                    COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                        ...
                                                                                                                                        EXPECTED_NO_SCRIPT_IDENTITY=EXPECTED_$( ARGUMENTS=$( ${ scripts.util.hash } ${ environment-variable "EXPECTED_IDENTITY" } no-script argument ) STANDARD_INPUT="" ${ scripts.util.identity } ) &&
