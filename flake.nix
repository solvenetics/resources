                                                                                                                             ...
                                                                                                                             delta : has-standard-input : arguments : standard-input :
                                                                                                                                ''
                                                                                                                                    COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                        ...
                                                                                                                                        # OBSERVED_NO_SCRIPT_IDENTITY=$( ${ pkgs.coreutils }/bin/cat /build/=$( ARGUMENTS=$( ${ scripts.util.hash } ${ environment-variable "EXPECTED_IDENTITY" } no-script argument ) STANDARD_INPUT="" ${ scripts.util.identity } ) ) &&
