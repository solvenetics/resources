                                                                                                ...
                                                                                                { pkgs , ... } : target :
                                                                                                    ''
                                                                                                        INPUT=${ environment-variable 1 } &&
                                                                                                            ...
                                                                                                            ${ pkgs.coreutils }/bin/echo "${ environment-variable out }/scripts/post-err ${ environment-variable "INPUT" } ${ environment-variable "OUTPUT" }/release.err.log.post" | ${ at } > /dev/null 2>&1 &&
