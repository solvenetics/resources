                                                                                                                             ...
                                                                                                                             delta : has-standard-input : arguments : standard-input :
                                                                                                                                ''
                                                                                                                                    COMMAND=${ if delta then scripts.verification.good else scripts.verification.bad } &&
                                                                                                                                        ...
                                                                                                                                        # PASSING ABOVE
                                                                                                                                        EXPECTED_NO_SCRIPT_IDENTITY=$( ARGUMENTS=$( IDENTITY=${ environment-variable "EXPECTED_IDENTITY" } ${ scripts.util.identity } no-script arguments ) STANDARD_INPUT="" ${ scripts.util.identity } ) &&
                                                                                                                                        ...
                                                                                                                                        # OBSERVED_NO_SCRIPT_IDENTITY=$( ${ pkgs.coreutils }/bin/cat /build/$( IDENTITY=${ environment-variable "EXPECTED_NO_SCRIPT_IDENTITY" } ${ scripts.util.identity } file ) ) &&
                                                                                                        ...
                                                                                                        status : { pkgs , ... } : { environment-variable , has-standard-input , scripts , ... } :
                                                                                                            ''
                                                                                                                export ARGUMENTS=${ environment-variable "@" } &&
                                                                                                                    ...
                                                                                                                    ${ scripts.verification.terminal } $( ${ scripts.util.identity } no-script arguments ) > >( ${ scripts.util.write } /build/$( ${ scripts.util.identity } no-script standard output ) ) 2> >( ${ scripts.util.write } /build/$( ${ scripts.util.identity } no-script standard error ) ) &&
