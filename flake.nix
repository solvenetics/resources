                                                                                    ...
                                                                                    verification =
                                                                                        {
                                                                                            bad =
                                                                                                {
                                                                                                    bad = temporary : { temporary = temporary.cache.bad.bad ; epoch = 4 ; } ;
                                                                                                    good = temporary : { temporary = temporary.cache.bad.good ; epoch = 4 ; } ;
                                                                                                } ;
                                                                                            good =
                                                                                                {
                                                                                                    bad = temporary : { temporary = temporary.cache.good.bad ; epoch = 4 ; } ;
                                                                                                    good = temporary : { temporary = temporary.cache.good.good ; epoch = 4 ; } ;
                                                                                                } ;
                                                                                        } ;
                                                                                } ;
                                                                                        ...
                                                                                        cache =
                                                                                            {
                                                                                                bad =
                                                                                                    {
                                                                                                        bad = scripts : { init = scripts.verification.cache.init.bad.fast ; release = scripts.verification.cache.init.bad.fast ; } ;
                                                                                                        good = scripts : { init = scripts.verification.cache.init.bad.fast ; release = scripts.verification.cache.init.good.fast ; } ;
                                                                                                    } ;
                                                                                                good =
                                                                                                    {
                                                                                                        bad = scripts : { init = scripts.verification.cache.init.good.fast ; release = scripts.verification.cache.init.bad.fast ; } ;
                                                                                                        good = scripts : { init = scripts.verification.cache.init.good.fast ; release = scripts.verification.cache.init.good.fast ; } ;
                                                                                                    } ;
                                                                                            } ;
