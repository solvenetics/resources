                                                                                                            ...
                                                                                                            cache =
                                                                                                                {
                                                                                                                    ...
                                                                                                                    good =
                                                                                                                        {
                                                                                                                            bad = cache "RELEASE" 69 ;
                                                                                                                            good = cache "RELEASE" 0 ;
                                                                                                                        } ;
                                                                                                                } ;
                                                                                                            good = internal 0 ;
                                                                                                            temporary =
                                                                                        ...
                                                                                        cache =
                                                                                            {
                                                                                                bad =
                                                                                                    {
                                                                                                        bad = scripts : { init = scripts.verification.cache.init.bad ; release = scripts.verification.cache.init.bad ; } ;
                                                                                                        good = scripts : { init = scripts.verification.cache.init.bad ; release = scripts.verification.cache.init.good ; } ;
                                                                                                    } ;
                                                                                                good =
                                                                                                    {
                                                                                                        bad = scripts : { init = scripts.verification.cache.init.good ; release = scripts.verification.cache.init.bad ; } ;
                                                                                                        good = scripts : { init = scripts.verification.cache.init.good ; release = scripts.verification.cache.init.good ; } ;
                                                                                                    } ;
                                                                                            } ;
